...
(function () {
    var m = this || self,
        ...
        da = function (a, b, c) {
            da = Function.prototype.bind && -1 != Function
                .prototype
                .bind
                .toString()
                .indexOf("native code")
    ...
    var ja = function (a, b, c, d) {
        ...
        ma = function (a, b, c) {
            "string" !== typeof a && ja("Expected string but got %s: %s.", [
                aa(a), a
    ...
    var pa = function (a) {
            if (a instanceof t && a.constructor === t && a.ga === oa) 
                return a.T;
    ...
    var va = function (a) {
            if (a instanceof z && a.constructor === z && a.ea === ua) 
                return a.G;
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var J = function (a, b, c) {
        ...
        Na = new RegExp(
            /^/.source + /([a-zA-Z][-+.a-zA-Z0-9]*:)?/.source + /(\/\/[^\/?#]*)?/.source +
        ...
        Ta = function (a) {
            ...
            a = a
                ...
                .replace(Pa, function (e) {
                    return e.replace(/%/g, "%25")
                })
                .replace(Ra, function (e) {
        ...
        Ya = function (a, b) {
            ...
            if (k && "undefined" != typeof k.HTMLAnchorElement && (!a || !(a instanceof k.HTMLAnchorElement) && (a instanceof k.Location || a instanceof k.Element))) {
                k = typeof a;
                if ("object" == k && null != a || "function" == k) 
                    try {
                        var h = a.constructor.displayName || a.constructor.name || Object
                            .prototype
                            .toString
                            .call(a)
                    } catch (l) {
            ...
            b instanceof w
                ? h = b
                : (h = b, h instanceof w || (
                    h = "object" == typeof h && h.w
                        ? h.v()
                        : String(h),
                    ka(sa.test(h), "%s does not match the safe URL pattern", h) || (
                        h = "about:invalid#zClosurez"
                    ),
                    h = new w(qa, h)
                ));
            h instanceof w && h.constructor === w && h.fa === ra
                ? h = h.R
                : (
                    la("expected object of type SafeUrl, got '" + h + "' of type " + aa(h)),
    ...
    var $a = function (a, b, c, d) {
            if (A[c + "EventListener"]) 
                A[c + "EventListener"](a, b, !1);
            else if (A[d + "tachEvent"]) 
                A[d + "tachEvent"]("on" + a, b)
        },
        ab = function () {
            var a = B.readyState;
            return "complete" === a || "interactive" === a && -1 == navigator
                .userAgent
                .indexOf("MSIE")
        },
        db = function (a) {
    ...
    var tb = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Bb = function (a, b, c, d) {
            ...
            g
                ? k = g(e, b, c, d)
                : O("no hint processor for: " + f);
            k || O("failed to generate load url");
            b = k;
            c = b.match(yb);
            (d = b.match(zb)) && 1 === d.length && Ab.test(b) && c && 1 === c.length || O(
                "failed sanity: " + a
            );
            return k
        },
        ...
        Cb = function (a) {
            ...
            c = 0;
            for (d = ub.length; c < d; ++c) 
                ub[c].test(b) && O("invalid_prefix");
            c = Fb(a, "k", !0);
            d = Fb(a, "am");
            e = Fb(a, "rs");
            a = Fb(a, "t");
    ...
    var Sb = function (a) {
            ...
            if (b && "object" === typeof b) 
                for (var d in b) 
                    !Object
                        .prototype
                        .hasOwnProperty
                        .call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (
                            a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Ub(a[d]) && !Ub(b[d])
                                ? P(a[d], b[d])
        ...
        Wb = function (a, b) {
            ...
            a.length && a[a.length - 1] && Object
                .hasOwnProperty
                .call(a[a.length - 1], "___goc") && "undefined" === typeof a[a.length - 1]
                .___goc && (c = a.pop());
            P(c, b);
            a.push(c)
        },
    ...
    var lc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        ...
        oc = function (a) {
            ...
            null == b && (
                b = (a = (a || window.location.href).match(mc))
                    ? a[1]
                    : null
            );
            if (null == b) 
    ...
    var pc,
        ...
        d = typeof a;
            if ("undefined" !== d) {
                ...
                b = [];
                var e = V(a);
                if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a, "toJSON") || (e !== vc || a.constructor !== Array && a.constructor !== Object) && (e !== uc || a.constructor !== Array && a.constructor !== Object) && e !== tc && e !== qc && e !== sc && e !== rc)) 
                ...
                if (null == a) 
                    ...
                    if (e === rc) 
                        return W(a.toISOString.call(a), c);
        ...
        Nc = function (a) {
            a = String(a);
            if (wc.test(a) || xc.test(a) || yc.test(a) || zc.test(a)) 
                return !1;
            var b = a.replace(Ac, '""');
            b = b.replace(Bc, "0");
            b = b.replace(Cc, "");
            ...
            b = b.replace(Ec, "0");
            b = b.replace(Fc, "0");
            if (Gc.test(b) || Hc.test(b) || Ic.test(b) || Jc.test(b) || !b || (b = b.replace(Kc, ""))) 
                return !1;
            a = a
                .replace(Lc, "\\u2028")
                .replace(Mc, "\\u2029");
        ...
        Oc = function () {
            ...
            if ((void 0 === pc || void 0 === T || S !== a) && -1 !== S) {
                ...
                try {
                    try {
                        T = !!m.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === m
                            .JSON
                            .stringify
                            .call(m.JSON, {
                                a: [
        ...
        Rc = !Date.prototype.toISOString || "function" !== typeof Date.prototype.toISOString || "1970-01-01T00:00:00.000Z" !== (
            new Date(0)
        ).toISOString(),
        Sc = function () {
            var a = Date
    ...
    var Vc = function (a, b, c) {
        ...
        if ("string" === typeof b) 
            for (var e = 0; 16 > e; e++) 
                d[e] = b.charCodeAt(c) << 24 | b.charCodeAt(c + 1) << 16 | b.charCodeAt(c + 2) << 8 | b.charCodeAt(
                    c + 3
                ),
                c += 4;
    else 
    ...
    Uc.prototype.digest = function () {
        var a = [],
            b = 8 * this.H;
        56 > this.A
            ? this.update(this.F, 56 - this.A)
            : this.update(this.F, this.l - (this.A - 56));
    ...
    var Xc = A.crypto,
        ...
        ed = function (a) {
            ...
            for (c = 0; c < b.length; c++) 
                a += "0123456789ABCDEF".charAt(Math.floor(b[c] / 16)) + "0123456789ABCDEF".charAt(
                    b[c] % 16
                );
            return a
        };
    ...
    Yc || (
        bd = 1E6 * (screen.width * screen.width + screen.height),
        cd = ed(
            B.cookie + "|" + B.location + "|" + (
                new Date
            ).getTime() + "|" + Math.random()
        ),
        Zc = Q("random/maxObserveMousemove") || 0,
        0 != Zc && $a("mousemove", dd, "add", "at")
    );
    var fd = function () {
            var a = ad;
    ...
    var ld = {
        ...
        nd = 0,
        od = function (a) {
            H(!a || Za.test(a), "Illegal url for new iframe - " + a)
        },
        pd = function (a, b, c, d, e) {
            ...
            try {
                document.all && (f = a.createElement(
                    '<iframe frameborder="' + Ka(String(c.frameborder)) + '" scrolling="' + Ka(String(c.scrolling)) +
                    '" ' + k + ' name="' + Ka(String(c.name)) + '"/>'
                ))
            } catch (l) {} finally {
            ...
            for (var h in c) 
                ...
                "style" === h && "object" === typeof a
                    ? G(a, f.style)
                    : md[h] || f.setAttribute(h, String(a));
    ...
    var vd = function (a) {
        ...
        wd = function (a) {
            ...
            for (
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = vd(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i)) 
                    return e
            }
    ...
    var xd = {
        ...
        Ad = (
            "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefre" +
            "sh"
        ).split(" "),
        Bd = C(L, "WI", D()),
        Cd = function (a, b, c) {
            ...
            (d = Q("iframes/" + d + "/url")) || (
                d = ":im_socialhost:/:session_prefix::im_prefix:_/widget/render/" + f + "?usega" +
                "pi=1"
            );
            for (var g in xd) 
                e[g] = g + "/" + (
            ...
            e = Ya(B, d.replace(rd, ud(e)));
            g = "iframes/" + a + "/params/";
            f = {};
            G(b, f);
            (d = Q("lang") || Q("gwidget/lang")) && (f.hl = d);
            yd[a] || (
                f.origin = window.location.origin || window.location.protocol + "//" + window.location.host
            );
            f.exp = Q(g + "exp");
            if (g = Q(g + "location")) 
            ...
            c = {};
            for (var l in f) 
                E(f, l) && h.test(l) && (c[l.replace(h, "")] = f[l], delete f[l]);
            l = "q" == Q("iframes/" + a + "/params/si")
                ? f
                : c;
            h = cc();
            for (var n in h) 
                !E(h, n) || E(f, n) || E(c, n) || (l[n] = h[n]);
            n = [].concat(Ad);
            (l = Q("iframes/" + a + "/methods")) && "object" === typeof l && Ca.test(
                l.push
            ) && (n = n.concat(l));
            for (var p in b) 
                E(b, p) && /^on/.test(p) && ("plus" != a || "onconnect" != p) && (
                    n.push(p),
                    delete f[p]
                );
            delete f.callback;
        ...
        Fd = function (a) {
            for (
                ...
                var f = a.attributes[d],
                    g = f.name,
                    k = f.value;
                0 <= Da.call(Dd, g) || c && 0 != g.indexOf("data-") || "null" === k || "specified" in f && !f.specified || (
                    c && (g = g.substr(5)),
                    b[g.toLowerCase()] = k
                )
            }
        ...
        Od = function (a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                var l = h
                        ...
                        .toLowerCase(),
                    n = void 0;
                if (h.getAttribute("data-gapiscan")) 
                    k = null;
                else {
                    var p = l.indexOf("g:");
                    0 == p
                        ? n = l.substr(2)
                        : (p = (p = String(h.className || h.getAttribute("class"))) && Md.exec(p)) && (
                            n = p[1]
                        );
                    k = !n || !(Id[n] || Jd[n] || X[n]) || k && n !== k
                        ? null
                        : n
                }
                k && (
                    Nd[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != La(Fd(g)).length
                ) && (g.setAttribute("data-gapiscan", !0), C(c, k, []).push(g))
            }
            if (b) 
                for (var r in c) 
            ...
            switch (Yd(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        b = k.attributes || {};
                        H(
                            !(k.allowPost || k.forcePost) || !b.onload,
                        ...
                        n = n || "";
                        !n && r && (
                            r = J(b.location.href, "_gfid", "") || J(b.location.href, "id", ""),
                            n = J(b.location.href, "pfname", ""),
                            n = r
                                ? n + "/" + r
                                : ""
                        );
                        n || (r = Pc(J(b.location.href, "jcp", ""))) && "object" == typeof r && (
                            n = (n = r.id)
                                ? r.pfname + "/" + n
                                : ""
                        );
                        ...
                        r || (r = k.rpctoken || String(Math.round(1E8 * (
                            Yc
                                ? gd()
                                : fd()
                        ))), p.rpctoken = r);
                        ...
                        if (h.forcePost || p && 2E3 < f.length) {
                            h = Ta(f);
                            l.src = "";
                            k.dropDataPostorigin || (l["data-postorigin"] = f);
                            f = pd(b, c, l, e);
                ...
                if ("_renderstart" === d.s || d.s === de + "/" + a + "::_renderstart") 
                    if (d = d.a && d.a[
                        c
                            ? 0
                            : 1
                    ], b = B.getElementById(a), jc(a, 2), d && b && d.width && d.height) {
                        a : {
                            c = b.parentNode;
                            a = d || {};
                            if (gc()) {
                            ...
                            (d = c.nextSibling) && d.getAttribute && d.getAttribute("data-gapistub") && (
    ...
    je.prototype.read = function () {
        if (Y.hasOwnProperty(this.D)) 
            return Y[this.D]
    };
    je.prototype.write = function (a) {
        Y[this.D] = a;
        return !0
    };
    ...
    je.iterate = function (a) {
        for (var b in Y) 
            Y.hasOwnProperty(b) && a(b, Y[b])
    };
    var ke = "https:" === window.location.protocol,
        le = ke || "http:" === window.location.protocol
            ? ge
            : je,
        me = function (a) {
            var b = a.substr(1),
    ...
    Z.prototype.aa = function () {
        this.L && (
            this.W()
                ? this.B = this.U
                : this.B = Math.min(2 * (this.B || this.U), 120),
            window.setTimeout(da(this.aa, this), 1E3 * this.B)
        )
    };
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            "ci": {
                ...
                "iframes": {
                    ...
                    "plus_share": {
                        ...
                        "url": ":socialhost:/:session_prefix::se:_/+1/sharebutton?plusShare\u003dtrue\u0026use" +
                                "gapi\u003d1"
                    },
                    "rbr_s": {
                        "params": {
                    ...
                    ":source:": "3p",
                    "playemm": {
                        "url": "https://play.google.com/work/embedded/search?usegapi\u003d1\u0026usegapi\u003d" +
                                "1"
                    },
                    "savetoandroidpay": {
                    ...
                    "backdrop": {
                        "url": "https://clients3.google.com/cast/chromecast/home/widget/backdrop?usegapi\u003d" +
                                "1"
                    },
                    "visibility": {
                        "params": {
                    ...
                    "sharetoclassroom": {
                        "url": "https://www.gstatic.com/classroom/sharewidget/widget_stable.html?usegapi\u003d" +
                                "1"
                    },
                    "ytshare": {
                        "params": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.xh-S9KbEGSE.O/am\u003dwQc/d\u003d1" +
                    "/ct\u003dzgms/rs\u003dAGLTcCNaUSRWzhd71dAsiMVOstVE3KcJZw/m\u003d__features__",
